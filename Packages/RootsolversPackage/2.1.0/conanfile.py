...
class RootSolvers(ConanFile):
    ...
    description = "root solvers for 1D functions, conan exercise; newton requires derivative for captured lambda"
    settings = "cppstd", "os", "compiler", "build_type", "arch"
    requires = "FinitediffPackage/[~=1 >=1.1]"   # std::function only supported from minor version 1

...
class Minimizers(ConanFile):
    ...
    description = "minimization solvers for 1D convex functions; replaces float with double"
    settings = "cppstd", "os", "compiler", "build_type", "arch"
    requires = "FinitediffPackage/[~=1 >=1.2]" # package needs double but not templates
